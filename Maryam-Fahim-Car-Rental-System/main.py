...
from config import APP_TITLE, APP_VERSION, OWNER_NAME, THEME
...
class CarRentalApp:
    ...
    def __init__(self, root: tk.Tk):
        ...
        center_window(self.root, 1180, 760)
    ...
    def exit_app(self):
        ...
        if messagebox.askokcancel("Exit", f"Are you sure you want to exit {OWNER_NAME} Car Rental?"):
