...
from config import OWNER_NAME, THEME, FONTS, CAR_CATEGORIES, DEFAULT_SECURITY_DEPOSIT
...
from views.styles import StatCard, create_button, create_scrollable_treeview, center_window, configure_status_tags
...
class CustomerDashboard(tk.Frame):
    ...
    def _build_layout(self):
        ...
        tk.Label(brand_frame, text="Rental Experience Portal", font=FONTS["small"], fg=THEME["primary_light"], bg=THEME["sidebar_bg"]).pack(anchor="w")
    ...
    def _show_browse_cars(self):
        ...
        tree_container.pack(fill="both", expand=True)
        configure_status_tags(self.browse_tree)
