...
DEMO_ADMIN_USERNAME = "maryam_admin"
DEMO_ADMIN_PASSWORD = "Maryam@Admin123"
DEMO_ADMIN_NAME = "Maryam Fahim - Administrator"
DEMO_ADMIN_EMAIL = "maryam.fahim@bankmanagement.com"
