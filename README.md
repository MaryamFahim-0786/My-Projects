# Maryam Fahim • Car Rental Management System

**Smart Fleet Management • Rentals • Payments • Analytics**
...
|---|---|---|---|
| **Maryam Fahim (Owner/Admin)** | `maryam` | `admin123` | Full administrative control |
| **Demo Customer 01** | `customer_demo_01` | `customer123` | Pre-configured active rental |
| **Demo Customer 02** | `customer_demo_02` | `customer123` | Pre-configured completed rental |
